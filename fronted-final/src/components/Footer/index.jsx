      ...
      <footer className='footer__main'>
        <div className='footer__container'>
                ...
                <li className='m-0'>
                  <a href='https://www.facebook.com/luisalfonso.lechugahernandez/' target='blank'>
                    <svg
                      ...
                      className='bi bi-facebook anim-img'
                      viewBox='0 0 16 16'
                    >
                ...
                <li>
                  <a href='https://www.instagram.com/luis_lechuga55/' target='blank'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='24' height='24' fill='currentColor'
                      className='bi bi-instagram anim-img'
                      viewBox='0 0 16 16'
                    >
                ...
                <li>
                  <a href='https://www.linkedin.com/in/luis-lechuga-hdz/' target='blank'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='24' height='24' fill='currentColor'
                      className='bi bi-twitter anim-img'
                      viewBox='0 0 16 16'
                    >
                ...
                <li>
                  <a href='https://github.com/LuisLechuga55' target='blank'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='24' height='24' fill='currentColor'
                      className='bi bi-telegram anim-img'
                      viewBox='0 0 16 16'
                    >
                ...
                <li>
                  <a href='#' target='blank'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='24' height='24' fill='currentColor'
                      className='bi bi-youtube anim-img'
                      viewBox='0 0 16 16'
                    >
          ...
          <div className='footer__foot'>
            <h3 className='footer__foot__h'>Copyright © 2020 All Rights Reserved</h3>

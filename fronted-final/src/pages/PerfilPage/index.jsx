...
function PerfilPage () {
  const { costumer, logoutCostumer } = useContext(AuthContext)
  ...
  const { input, handleInputChange, handleSubmit } = useForm(updatePerfil, {
    role: ''
  })
      ...
      <div className='card-perfil my-4'>
        ...
        <a href='https://www.facebook.com/luisalfonso.lechugahernandez/' target='blank'>
          <svg
            ...
            className='bi bi-facebook anim-img link-perfil'
            viewBox='0 0 16 16'
          >
        ...
        <a href='https://www.instagram.com/luis_lechuga55/' target='blank'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24' height='24' fill='currentColor'
            className='bi bi-instagram anim-img link-perfil'
            viewBox='0 0 16 16'
          >
        ...
        <a href='https://www.linkedin.com/in/luis-lechuga-hdz/' target='blank'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24' height='24' fill='currentColor'
            className='bi bi-twitter anim-img link-perfil'
            viewBox='0 0 16 16'
          >
        ...
        <a href='https://github.com/LuisLechuga55' target='blank'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='24' height='24' fill='currentColor'
            className='bi bi-telegram anim-img link-perfil'
            viewBox='0 0 16 16'
          >
          ...
          ? (
            <form className='form-signin' onSubmit={handleSubmit}>
              <div className='form-floating my-1'>
                ...
                <label htmlFor='role' className='form-label'>¿You want to change role type?</label>
              </div>

              <button
                className='w-100 btn-perfil-page my-3'
                type='submit'
              >
                Cambiar
              </button>
        ...
        <button
          type='button'
          className='btn btn-danger btn-delete-perfil'
          onClick={deletePerfil}
        >
          Eliminar Cuenta
        </button>
